...
def loadAgent(pacman, nographics):
    ...
    pythonPathStr = "C:/Users/SISTEM/OneDrive/Documents/Python_VSCodeProjects/AI-Pacman-1/Pacman/hw2-multiagent/"
    # pythonPathStr = ''.join(sys.path)
    print("LoadAgent---")
    print(pythonPathStr)
    ...
    for moduleDir in pythonPathDirs:
        print("G")
        # if not os.path.isdir(moduleDir): continue; print("F")
